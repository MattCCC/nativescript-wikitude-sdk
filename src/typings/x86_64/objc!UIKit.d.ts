...
declare class UIView extends UIResponder implements CALayerDelegate, NSCoding, UIAccessibilityIdentification, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UITraitEnvironment {
	...
	hideAllToastsWithIncludeActivityClearQueue(includeActivity: boolean, clearQueue: boolean): void;
	...
	makeToastActivity(point: CGPoint): void;

	makeToastActivityWith(position: ToastPosition): void;

	makeToastWith(message: string): void;

	makeToastWithOffset(message: string, offset: CGPoint): void;

	makeToastWithPoint(message: string, point: CGPoint): void;
	...
	showToastDurationPointCompletion(toast: UIView, duration: number, point: CGPoint, completion: (p1: boolean) => void): void;

	showToastDurationPositionCompletion(toast: UIView, duration: number, position: ToastPosition, completion: (p1: boolean) => void): void;

	showToastDurationPositionCompletionOffset(toast: UIView, duration: number, position: ToastPosition, completion: (p1: boolean) => void, offset: CGPoint): void;
	...
	toastViewForMessageTitleImageStyleError(message: string, title: string, image: UIImage, style: ToastStyle): UIView;
